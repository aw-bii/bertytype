...
class _SettingsDialog(QDialog):
    def __init__(self, cfg: Config, on_save: Callable[[Config], None]) -> None:
        ...
        self.setAccessibleName("BertyType Settings")
    ...
    def _build_ui(self, cfg: Config) -> None:
        ...
        self._mode_combo.setAccessibleName("Recording Mode")
        self._mode_combo.setAccessibleDescription("ptt: hold to record / double_tap_toggle: tap twice to toggle recording")
        ...
        self._hotkey_edit.setAccessibleName("Hotkey")
        self._hotkey_edit.setAccessibleDescription("Press the key combination to use as your push-to-talk hotkey")
        ...
        self._dtw_slider.setAccessibleName("Double-tap Window")
        self._dtw_slider.setAccessibleDescription("Max time between two taps to trigger double-tap toggle, 0.05 to 2.00 seconds")
        self._dtw_label = QLabel(f"{cfg.double_tap_window:.2f}s")
        self._dtw_label.setAccessibleName("Double-tap Window value")
        ...
        form.addRow("Double-tap Window", dtw_layout)
        ...
        self._cancel_edit.setAccessibleName("Cancel Hotkey")
        ...
        self._model_edit.setAccessibleDescription("Ollama model name for LLM refinement")
        ...
        self._refine_check.setAccessibleName("Refine with LLM")
        self._refine_check.setAccessibleDescription("Run transcribed text through the LLM to clean up filler words and punctuation")
        ...
        self._vad_slider.setAccessibleName("VAD Threshold")
        self._vad_slider.setAccessibleDescription("Silence threshold for voice activity detection, 0.00 is very sensitive, 1.00 is least sensitive")
        self._vad_label = QLabel(f"{cfg.vad_threshold:.2f}")
        self._vad_label.setAccessibleName("VAD Threshold value")
        ...
        form.addRow("VAD Threshold", vad_layout)
        ...
        self._llm_to_edit.setAccessibleName("LLM Timeout")
        self._llm_to_edit.setAccessibleDescription("Seconds to wait for LLM response before timing out, 1 to 600")
        ...
        self._delay_edit.setAccessibleName("Injection Delay")
        self._delay_edit.setAccessibleDescription("Seconds to wait after focusing target window before injecting text, 0.0 to 5.0")
